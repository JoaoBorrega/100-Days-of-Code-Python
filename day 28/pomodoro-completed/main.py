...
start_button = Button(text="Start", bg=GREEN, font=("Arial", 10, "bold"), command=start_timer)
start_button.grid(column=0, row=3)

reset_button = Button(text="Reset", bg=RED, font=("Arial", 10, "bold"), command=reset_timer)
